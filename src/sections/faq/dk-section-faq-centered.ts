...
@customElement('dk-section-faq-centered')
export class DkSectionFaqCentered extends DkSectionElement {
  static override styles = [faqBaseStyles, centeredStyles];
...
declare global {
  interface HTMLElementTagNameMap {
    'dk-section-faq-centered': DkSectionFaqCentered;
  }
}
