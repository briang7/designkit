...
const withToggleStyles = css`
  ...
  .toggle[data-active] .toggle-knob {
...
@customElement('dk-section-pricing-with-toggle')
export class DkSectionPricingWithToggle extends DkSectionElement {
  static override styles = [pricingBaseStyles, withToggleStyles];
...
declare global {
  interface HTMLElementTagNameMap {
    'dk-section-pricing-with-toggle': DkSectionPricingWithToggle;
  }
}
