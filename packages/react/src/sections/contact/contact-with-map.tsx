    ...
    >
      ...
      >
        ...
        >
          ...
          <div data-part="info-col">
            <div
              data-part="map"
              className="rounded-[var(--dk-radius-lg,0.75rem)] overflow-hidden min-h-[260px] bg-[var(--dk-color-neutral-100,#f3f4f6)] [&>*]:w-full [&>*]:min-h-[260px] [&>*]:block"
            >
              {map}
            </div>
            <div data-part="contact-details" className="flex flex-col gap-[var(--dk-space-4,1rem)] mt-[var(--dk-space-6,1.5rem)]">
              {email && (
                <div className="flex items-start gap-[var(--dk-space-3,0.75rem)]">
                  <svg className="shrink-0 w-5 h-5 text-[var(--dk-color-primary,#3b82f6)] mt-0.5" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" aria-hidden="true">
