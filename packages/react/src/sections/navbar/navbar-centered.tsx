  ...
  return (
    ...
    >
      ...
      >
        <div
          data-part="container"
          className="flex items-center justify-center w-full max-w-[var(--dk-section-max-width,1200px)] mx-auto"
        >
          <div
            data-part="links-left"
            className="hidden md:flex items-center gap-[var(--dk-navbar-link-gap,0.5rem)] flex-1 justify-end"
          >
            {linksLeft}
          </div>
          ...
          <div
            data-part="brand"
            className="flex items-center gap-2 text-xl font-bold text-dk-text whitespace-nowrap shrink-0 mx-6 md:order-none order-first md:mx-6 mx-0 md:mr-6 mr-auto"
          >
            {logo || brand}
          </div>

          <div
            data-part="links-right"
            className="hidden md:flex items-center gap-[var(--dk-navbar-link-gap,0.5rem)] flex-1 justify-start"
          >
            {linksRight}
          </div>
